package com.zjh.bookshop.utils;
...
public class PictureUtil {
    ...
    static {
        basePath = PictureUtil.class.getResource("/static/images").getPath();
    }
     ...
     * @return url
     */
    public static String copyFile(String tempPath,String folder) throws IOException {
        ...
        String filePath = basePath + "/" + folder + "/" + fileName;
        FileUtils.copyFile(bannerPic, new File(filePath));
        String url = "http://47.106.245.151:18080/images/" + folder + "/" + fileName;
        return url;
    }
     ...
     * @throws IOException
     */
    public static String zoomBySize(String path,String folder, int width, int height) throws IOException {
        ...
        //获取目标路径
        String dest = basePath + "/" + folder + "/" + fileName ;
        log.info(dest);
        //读取图片,返回一个BufferedImage对象
